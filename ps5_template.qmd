...
zip_shapefile_path = '/Users/apple/Desktop/class/Dap-2/problem_sets/ps5/Ruyu-problem-set-5-paired-part/gz_2010_us_860_00_500k.shp'
population_csv_path = '/Users/apple/Desktop/class/Dap-2/problem_sets/ps5/Ruyu-problem-set-5-paired-part/DECENNIALDHC2020.P1-Data.csv'
...
zip_gdf = zip_gdf.merge(population_df, left_on="ZCTA5CE10", right_on="ZCTA", how="left")
print("Merged ZIP Code shapefile with population data:")
print(zip_gdf.head())
...
district_shapefile_path = '/path/to/US_Attorney_Districts_Shapefile.shp'  # Replace with actual path
...
district_population = zip_district_join.groupby('DISTRICT_NAME')['P1_TOTAL_POPULATION'].sum().reset_index()
...
district_map_gdf = district_gdf.merge(district_data, left_on='DISTRICT_NAME', right_on='District')
